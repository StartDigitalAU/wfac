...
gulp.task("styles", function () {
    var styles = ["css/style.scss", "css/easepick.scss"];
...
gulp.task("concat", ["uglify", "uglify-lib"], function () {
    // Concat & return
    return gulp
        .src(["js/lib/*.min.js", "js/min/*-ugl.js"], {
            base: "js/",
        })
...
gulp.task("watch", function () {
    ...
    gulp.watch("js/src/*", ["uglify", "uglify-lib", "concat"]);
    gulp.watch("js/lib/*", ["uglify", "uglify-lib", "concat"]);
});

gulp.task("minify", function () {
    var styles = ["css/style.css", "css/easepick.css"];
    for (let i = 0; i < styles.length; i++) {
        return gulp
            .src(styles[i])
            .pipe(csso())
