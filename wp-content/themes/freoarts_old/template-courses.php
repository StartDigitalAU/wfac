...
global $body_class;
$body_class = 'page-courses page-courses-landing';
...
<div class="whats-on-hero-landing" data-hero>
  <div class="container container--gutters">
    <?php
    $page_title = get_field('hero_title') ?: get_the_title();
    ...
    <?php if(!empty($intro)) { ?>
      <div class="whats-on-hero-landing__intro">
        <?= $intro; ?>
      </div>
    <?php } ?>
