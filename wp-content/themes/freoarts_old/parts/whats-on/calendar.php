<div class="sub-header-panel">
    <div class="sub-header-panel__inner">
        <div class="container container--gutters">
            ...
            <div class="filter-wrapper-outer" data-panel="type-events">
                <h2 class="title title--h2">Event Filters</h2>
                <ul>
                    <?php
                    $terms = get_terms([
            ...
            <div class="filter-wrapper-outer" data-panel="type-exhibitions">
                <h2 class="title title--h2">Exhibition Filters</h2>
                <ul>
                    <?php
                    $terms = get_terms([
                    ...
                    <section class="calendar">
                        <div class="inner" id="events-calendar">
                            ...
                            <div class="cal-grid">
                                ...
                                <div class="cal-days"><?php echo get_calendar_events_html('whatson', date('Y'), date('n'), true); ?></div>
                            </div>
