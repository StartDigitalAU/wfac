              ...
              <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                <tr>
                  <td class="mobile" style="line-height:20px;">
                    <table width="400" cellpadding="0" cellspacing="0" align="center" border="0" class="centerClass">
                      <tr>
              ...
              <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                ...
                <tr>
                  <td align="center" class="mobile"
                    ...
                    Quick reminder that your course, <strong><?php echo $enrolment['course_title']; ?></strong>, will be
                    starting soon.
                    <?php
