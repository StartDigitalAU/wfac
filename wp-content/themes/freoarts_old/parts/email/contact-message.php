              ...
              <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                ...
                <tr>
                  <td align="center" class="mobile"
                    ...
                    This is a receipt of your recent submission to our website.
                  </td>
                </tr>
              </table>
              <!-- End Container -->
                    ...
                    <table width="520" cellpadding="0" cellspacing="0" border="0" class="container" align="center"
                      ...
                      <tr style="background: #eeeeee;">
                        <td width="140" align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #000000; padding: 10px;"
                          class="mobile-left">First Name:</td>
                        <td align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #6f6f70; padding: 10px;"
                          class="mobile-left"><?php echo $first_name; ?></td>
                      </tr>
                      <tr style="background: #ffffff;">
                        <td width="140" align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #000000; padding: 10px;"
                          class="mobile-left">Last Name:</td>
                        <td align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #6f6f70; padding: 10px;"
                          class="mobile-left"><?php echo $last_name ?></td>
                      </tr>
                      <tr style="background: #eeeeee;">
                        <td width="140" align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #000000; padding: 10px;"
                          class="mobile-left">Email address:</td>
                        <td align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #6f6f70; padding: 10px;"
                          class="mobile-left"><?php echo $email ?></td>
                      </tr>
                      <tr style="background: #ffffff;">
                        <td width="140" align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #000000; padding: 10px;"
                          class="mobile-left">Contact Number:</td>
                        <td align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #6f6f70; padding: 10px;"
                          class="mobile-left"><?php echo $contact_number ?></td>
                      </tr>
                      <tr style="background: #eeeeee;">
                        <td width="140" align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #000000; padding: 10px;"
                          class="mobile-left">Message:</td>
                        <td align="left"
                          style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:18px; color: #6f6f70; padding: 10px;"
                          class="mobile-left"><?php echo $message ?></td>
                      </tr>
