              ...
              <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                ...
                <tr>
                  <td align="center" class="mobile"
                    ...
                    This is a receipt of your recent enrolment to
                    <strong><?php echo $enrolment['course_title']; ?></strong>.
                    <?php
                                    echo '<br>' . get_formatted_datetime($enrolment);
                                    if (!empty($enrolment['duration'])) {

                                        echo '<br>' . $enrolment['duration'];
                                    }
                                    ?>
                  </td>
                </tr>
                <tr>
                  <td align="center" class="mobile"
                    style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:20px; color: #2e2f2f;">
                    <a href="<?php echo $enrolment['course_url']; ?>" title="View Course">Click here to view course
                      details and find out what to bring.</a>
                  </td>
                </tr>
                <tr>
                  <td align="center" class="mobile"
                    style="font-family:roboto, helvetica, arial, sans-serif; font-size:14px; line-height:20px; color: #2e2f2f;">
                    For terms &amp; conditions please <a href="<?php echo $enrolment['tc_url']; ?>"
                      title="View terms &amp; conditions">click here.</a>
                  </td>
                </tr>
              </table>
              <!-- End Container -->
