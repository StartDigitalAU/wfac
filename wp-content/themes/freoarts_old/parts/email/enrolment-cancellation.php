              ...
              <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                ...
                <tr>
                  <td align="center" class="mobile"
                    ...
                    Enrolment Cancellation Confirmation.
                  </td>
                </tr>
                <tr>
                  ...
                  <tr>
                    <td align="center" class="mobile"
                      ...
                      <table width="560" cellpadding="0" cellspacing="0" border="0" class="container" align="center">
                        <tr>
                          <td class="mobile" style="font-size:14px; line-height:20px;" align="left">
                            Your course has been cancelled by Fremantle Arts Centre and a full refund will be
                            given.<br><br>

                            Order #<?php echo $enrolment['order_id']; ?><br>
                            <a href="<?php echo $enrolment['course_url']; ?>"
                              title="View Course"><?php echo $enrolment['course_title']; ?></a><br>
                            Amount Paid: $<?php echo $enrolment['paid_amount']; ?><br>
                            Amount Refunded: $<?php echo $refund_amount; ?><br><br>

                            <strong>Why has my course been cancelled?</strong><br>
                            Courses are cancelled due to low enrolment numbers, tutor illness and/or at the discretion of
                            Fremantle Arts Centre.<br><br>

                            <strong>What do I need to do to get my refund?</strong><br>
                            If you paid by credit card we will refund you automatically and may take up to 7 days.<br>
                            If you paid by any other method we will contact you to arrange a refund.<br>
                          </td>
                        </tr>
                      </table>
                  ...
                  <tr>
                    <td align="center" class="mobile"
                      ...
                      <table width="560" cellpadding="0" cellspacing="0" border="0" class="container" align="center">
                        <tr>
                          <td class="mobile" style="font-size:14px; line-height:20px;" align="left">
                            <strong>Order #<?php echo $enrolment['order_id']; ?></strong><br>
                            <a href="<?php echo $enrolment['course_url']; ?>"
                              title="View Course"><?php echo $enrolment['course_title']; ?></a><br>
                            Amount Paid: $<?php echo $enrolment['paid_amount']; ?><br>
                            Amount Refunded: $<?php echo $refund_amount; ?><br><br>

                            As you withdrew from a course five (5) or more days before the start date a refund of 80% of
                            your original payment will be given.<br><br>
                  ...
                  <tr>
                    <td align="center" class="mobile"
                      ...
                      <table width="560" cellpadding="0" cellspacing="0" border="0" class="container" align="center">
                        <tr>
                          <td class="mobile" style="font-size:14px; line-height:20px;" align="left">
                            As you withdrew four (4) or fewer days prior to the course start date no refund will be
                            issued.<br>
                          </td>
                        </tr>
                      </table>
