...
$types = [
    "news" => 'News',
    "media_release" => 'Media Releases',
];
?>

<form id="filter-news" class="filter filter--std">
          ...
          <div class="filter-search-toggle">
            ...
            <div class="filter-search-toggle__panel" data-expanded="false" id="search-filter">
              <label for="sub-search-field">
                <span class="u-vis-hide">Search News</span>
                <input type="text" id="sub-search-field" placeholder="Search News" name="search"
