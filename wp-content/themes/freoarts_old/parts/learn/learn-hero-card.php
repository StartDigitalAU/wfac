...
<article class="learn__hero">
    <a href="<?= $link ?>" class="learn__hero-wrapper">
        <div class="learn__hero-image-wrapper">
            <img class="learn__hero-img" src="<?= $img_src ?>" alt="<?= $img_alt ?>" />
        </div>
        <div class="learn__hero-content-wrapper">
            <span class="style--small_button learn__hero-date"><?= $start_date . ' - ' . $end_date ?></span>
            <div class="learn__hero-inner-content-wrapper">
                <h3 class="style--h5">
                    <?= $title ?>
                </h3>
                <div class="learn__hero-details style--h6">
